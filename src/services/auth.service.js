...
export const registerUser = async ({ nombre, apellido_pat, apellido_mat, usuario, tipo_id, clave, compania_id }) => {
  ...
  const perfil = await prisma.usuario.create({ data: { nombre, apellido_pat, apellido_mat, usuario, tipo_id, claveHash, compania_id } });
